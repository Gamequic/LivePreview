        ...
        <Grid container direction="column" alignItems="center" justifyContent="center" sx={{ minHeight: '100vh' }} spacing={gridSpacing}>
            ...
            <Grid item xs={12}>
                <Stack justifyContent="center" alignItems="center" spacing={gridSpacing} sx={{ p: 1.5, maxWidth: 350 }}>
                    <Typography variant="h1">¡La página no existe!</Typography>
                    <Typography variant="body2" align="center">
                        ¡La página que estás buscando ha sido movida, eliminada, renombrada o quizás nunca existió!
                    </Typography>
                    <AnimateButton>
                        <Button variant="contained" size="large" component={Link} to={DASHBOARD_PATH}>
                            <HomeTwoToneIcon sx={{ fontSize: '1.3rem', mr: 0.75 }} /> Volver a la pantalla principal
                        </Button>
                    </AnimateButton>
                </Stack>
            </Grid>
